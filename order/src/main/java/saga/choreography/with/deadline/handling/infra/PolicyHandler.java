...
public class PolicyHandler{
    ...
    @StreamListener(value=KafkaProcessor.INPUT, condition="headers['type']=='ExchangeFailed'")
    public void wheneverExchangeFailed_Reject(@Payload ExchangeFailed exchangeFailed){
    ...
    @StreamListener(value=KafkaProcessor.INPUT, condition="headers['type']=='PointUseFailed'")
    public void wheneverPointUseFailed_Reject(@Payload PointUseFailed pointUseFailed){
